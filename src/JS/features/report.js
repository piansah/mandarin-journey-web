  ...
  modal.innerHTML = `
    ...
    <div class="report-sheet">
      ...
      <div class="report-title">
        <span style="color:var(--gold); display:flex; align-items:center; gap:8px;">${SVG_BUG} Laporkan Masalah</span>
      </div>
