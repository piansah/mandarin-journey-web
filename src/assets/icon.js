...
/* ============================================================
   ASSETS/ICON.JS — Centralized SVG & Icon Library
   ============================================================ */

export const SVG_LISTEN = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 3C7.03 3 3 7.03 3 12C3 14.47 3.97 16.72 5.56 18.37L4.15 19.78C2.23 17.78 1 15.03 1 12C1 5.93 5.93 1 12 1C18.07 1 23 5.93 23 12C23 15.03 21.77 17.78 19.85 19.78L18.44 18.37C20.03 16.72 21 14.47 21 12C21 7.03 16.97 3 12 3Z" fill="currentColor"/><path d="M12 7C9.24 7 7 9.24 7 12C7 13.38 7.56 14.62 8.46 15.54L7.05 16.95C5.79 15.68 5 13.93 5 12C5 8.13 8.13 5 12 5C15.87 5 19 8.13 19 12C19 13.93 18.21 15.68 16.95 16.95L15.54 15.54C16.44 14.62 17 13.38 17 12C17 9.24 14.76 7 12 7Z" fill="currentColor"/><circle cx="12" cy="12" r="2.5" fill="currentColor"/></svg>`;
export const SVG_MIC = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="9" y="2" width="6" height="11" rx="3" fill="currentColor"/><path d="M5 11C5 14.87 8.13 18 12 18C15.87 18 19 14.87 19 11" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><line x1="12" y1="18" x2="12" y2="22" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><line x1="8" y1="22" x2="16" y2="22" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>`;
export const SVG_MIC_REC = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="9" y="2" width="6" height="11" rx="3" fill="#f87171"/><path d="M5 11C5 14.87 8.13 18 12 18C15.87 18 19 14.87 19 11" stroke="#f87171" stroke-width="2" stroke-linecap="round"/><line x1="12" y1="18" x2="12" y2="22" stroke="#f87171" stroke-width="2" stroke-linecap="round"/><line x1="8" y1="22" x2="16" y2="22" stroke="#f87171" stroke-width="2" stroke-linecap="round"/><circle cx="12" cy="12" r="10" stroke="#f87171" stroke-width="1.5" opacity="0.4"/></svg>`;
export const SVG_SPINNER = `<svg class="_rb_spinner" width="44" height="44" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 12C4 7.58 7.58 4 12 4C14.21 4 16.21 4.88 17.68 6.32" stroke="white" stroke-width="2.5" stroke-linecap="round"/><path d="M20 12C20 16.42 16.42 20 12 20C9.79 20 7.79 19.12 6.32 17.68" stroke="white" stroke-width="2.5" stroke-linecap="round"/><polyline points="17,3 18,7 14,6.5" stroke="white" stroke-width="2.2" stroke-linejoin="round" stroke-linecap="round"/><polyline points="7,21 6,17 10,17.5" stroke="white" stroke-width="2.2" stroke-linejoin="round" stroke-linecap="round"/></svg>`;
export const SVG_CAMERA = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z"/><circle cx="12" cy="13" r="4"/></svg>`;
export const SVG_STREAK = `<svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C9 7 6 9 6 13a6 6 0 0012 0c0-4-3-6-6-11z" fill="#eeb458" opacity="0.9"/><path d="M12 10c-1 2.5-2 3.5-2 5a2 2 0 004 0c0-1.5-1-2.5-2-5z" fill="#fff" opacity="0.4"/></svg>`;
export const SVG_STAR_XP = `<svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16 4L19.6 11.5L28 12.7L22 18.5L23.5 27L16 23.1L8.5 27L10 18.5L4 12.7L12.4 11.5L16 4Z" fill="#fef08a"/><path d="M16 4L19.6 11.5L28 12.7L22 18.5L23.5 27L16 23.1V4Z" fill="#eab308"/><path d="M16 8L18.5 13.2L24 14L20 17.8L21 23L16 20.3L11 23L12 17.8L8 14L13.5 13.2L16 8Z" fill="#fde047"/></svg>`;
export const SVG_BOOK = `<svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6 8C6 8 10 7 16 9V26C10 24 6 25 6 25V8Z" fill="#bfdbfe"/><path d="M26 8C26 8 22 7 16 9V26C22 24 26 25 26 25V8Z" fill="#60a5fa"/><path d="M16 9V26" stroke="#3b82f6" stroke-width="1.2"/><path d="M9 12C10.5 11.5 12 11.3 14 11.5" stroke="#3b82f6" stroke-width="1.2" stroke-linecap="round"/><path d="M9 15C10.5 14.5 12 14.3 14 14.5" stroke="#3b82f6" stroke-width="1.2" stroke-linecap="round"/><path d="M18 12C19.5 11.5 21.5 11.5 23 12" stroke="#1d4ed8" stroke-width="1.2" stroke-linecap="round"/><path d="M18 15C19.5 14.5 21.5 14.5 23 15" stroke="#1d4ed8" stroke-width="1.2" stroke-linecap="round"/></svg>`;
export const SVG_TROPHY = `<svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="9" y="6" width="14" height="3" rx="1.5" fill="#99f6e4"/><rect x="9" y="23" width="14" height="3" rx="1.5" fill="#2dd4bf"/><path d="M11 9C11 9 12 15 16 17C20 15 21 9 21 9H11Z" fill="#99f6e4"/><path d="M11 23C11 23 12 17 16 17C20 17 21 23 21 23H11Z" fill="#2dd4bf"/><path d="M13.5 20C14.5 18.5 16 18 16 18C16 18 17.5 18.5 18.5 20" stroke="#0f766e" stroke-width="1" stroke-linecap="round"/></svg>`;
export const SVG_TARGET = `<svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="16" cy="16" r="11" fill="#ede9fe"/><circle cx="16" cy="16" r="7" fill="#c4b5fd"/><circle cx="16" cy="16" r="3.5" fill="#a78bfa"/><circle cx="16" cy="16" r="1.2" fill="#fff"/><path d="M16 5V8M16 24V27M5 16H8M24 16H27" stroke="#7c3aed" stroke-width="1.5" stroke-linecap="round"/></svg>`;
export const SVG_RANK = `<svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 7H22V17C22 20.3 19.3 23 16 23C12.7 23 10 20.3 10 17V7Z" fill="#fbcfe8"/><path d="M16 7H22V17C22 20.3 19.3 23 16 23V7Z" fill="#f472b6"/><path d="M7 9H10V15C10 15 8 14 7 12V9Z" fill="#fbcfe8"/><path d="M25 9H22V15C22 15 24 14 25 12V9Z" fill="#f9a8d4"/><rect x="13" y="23" width="6" height="3" fill="#f472b6"/><rect x="11" y="26" width="10" height="2" rx="1" fill="#ec4899"/></svg>`;
export const SVG_LOGOUT = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e05555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>`;
export const SVG_CHECK_DUOLINGO_LARGE = `<svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 13L8.5 18L20 6" stroke="white" stroke-width="7.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`;
...
/* ── Expose ke window ── */
window.SVG_NODE_BOOK = SVG_NODE_BOOK;
window.SVG_NODE_BOOK = SVG_NODE_RANK;
window.SVG_CHECK_DUOLINGO_LARGE = SVG_CHECK_DUOLINGO_LARGE;
window.SVG_LISTEN = SVG_LISTEN;
window.SVG_MIC = SVG_MIC;
window.SVG_MIC_REC = SVG_MIC_REC;
window.SVG_SPINNER = SVG_SPINNER;
window.SVG_CAMERA = SVG_CAMERA;
window.SVG_STREAK = SVG_STREAK;
window.SVG_STAR_XP = SVG_STAR_XP;
window.SVG_BOOK = SVG_BOOK;
window.SVG_TROPHY = SVG_TROPHY;
window.SVG_TARGET = SVG_TARGET;
